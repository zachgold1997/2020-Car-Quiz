...
let html_question = "<div>score:"+questionsArray[5].score+"</div><div>Question Number:"+questionsArray[5].questionCounter+"</div><form class=\"questions-form\"><p>"+questionsArray[counter].question+"</p><label class=\"options\"><input  id=\"option-one\" type=\"radio\" name=\"option-one\"><span>"+questionsArray[counter].optionone+"</span></label><label class=\"options\"><input id=\"option-two\" type=\"radio\" name=\"option-two\"><span>"+questionsArray[counter].optiontwo+"</span></label><label class=\"options\"><input id=\"option-three\" type=\"radio\" name=\"option-three\"><span>"+questionsArray[counter].optionthree+"</span></label><label class=\"options\"><input id=\"option-four\" type=\"radio\" name=\"option-four\"><span>"+questionsArray[counter].optionfour+"</span></label><input type=\"button\" value=\"Submit Answer\" class=\"submit-button js-submit-button\"></form>";
